...
document.addEventListener("DOMContentLoaded", function() {
  ...
  <a href="Strona-główna.html" class="u-image u-logo u-image-1" data-image-width="196" data-image-height="188">
      ...
      <h1>Wybierz rodzaj pokoju:</h1>
    <form method="post" action="">
        <select name="rodzaj" class="u-active-palette-5-light-1 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-5-dark-2 u-palette-5-dark-1 u-radius-12 u-btn-1">
        ...
        <input class="u-active-palette-5-light-1 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-5-dark-2 u-palette-5-dark-1 u-radius-12 u-btn-1" type="submit"value="Wyświetl wpisy">
    </form>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $query = "SELECT imie, wpis, hotel, czystosc, image_path, rodzaj FROM ksiega WHERE rodzaj = '$rodzaj'";
        $result = $con->query($query);

        if ($result->num_rows > 0) {
            echo "<h2>Wpisy dotyczące rodzaju pokoju: $rodzaj</h2>";
          //  echo "<ul>";
            while ($row = $result->fetch_assoc()) {
              //  echo "<li>";
                echo "Imię: " . $row["imie"] . "<br>";
                echo "Wpis: " . $row["wpis"] . "<br>";
                echo "Hotel: " . $row["hotel"] . "<br>";
                echo "Czystość: " . $row["czystosc"] . "<br>";
                echo "Rodzaj: " . $row["rodzaj"] . "<br>";
                echo '<img src="' . $row["image_path"] . '" alt="o" high="200" width="200"><br>';
                echo "<hr>";
               // echo "</li>";
            }
           ...
           // echo "</ul>";
            ...
            echo "Brak wpisów dla wybranego rodzaju pokoju.";
        }
