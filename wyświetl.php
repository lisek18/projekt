...
<script>
        function skrocOpinie(opiniaId) {
            ...
            opinia.innerHTML = skroconaOpinia + '... <a href="#" onclick="pokazWiecej(\'' + opiniaId + '\')">Pokaż więcej</a>';
        }

        function pokazWiecej(opiniaId) {
            var opinia = document.getElementById(opiniaId);
            var opiniaTekst = opinia.getAttribute('data-pelna-opinia');
            opinia.innerHTML = opiniaTekst + ' <a href="#" onclick="skrocOpinie(\'' + opiniaId + '\')">Skróć</a>';
        }
    </script>
